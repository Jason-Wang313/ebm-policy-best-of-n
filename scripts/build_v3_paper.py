...
REPO_FINAL = ROOT / "paper" / "final" / "ebm-policy-best-of-n-v3.pdf"
DESKTOP_FINAL = Path.home() / "OneDrive" / "Desktop" / "ebm-policy-best-of-n-v3.pdf"
...
def main() -> int:
    ...
    run([sys.executable, "experiments/v3_cached_evidence.py"], ROOT, env)
