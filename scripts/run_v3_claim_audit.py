...
REPO_PDF = ROOT / "paper" / "final" / "ebm-policy-best-of-n-v3.pdf"
DESKTOP = Path.home() / "OneDrive" / "Desktop"
DESKTOP_PDF = DESKTOP / "ebm-policy-best-of-n-v3.pdf"
...
def main() -> int:
    ...
    summary = read_json(ROOT / "results" / "v3_cached_evidence" / "summary.json")
    ...
    require(summary["main_repair_worst_recovery"] >= 0.95, "main repair worst recovery below v3 threshold")
    ...
    require(summary["v3_figure_files"] >= 6, "v3 figures missing")
    ...
    expected_row = (
        "| `ebm-policy-best-of-n-v3.pdf` | `C:\\Users\\wangz\\ebm-policy-best-of-n` | "
        "`Jason-Wang313/ebm-policy-best-of-n` |"
    )
    require(expected_row in SOURCE_MAP.read_text(encoding="utf-8"), "source map row is not v3/exact")
    ...
    print("EBM policy v3 audit passed")
